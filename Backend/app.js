...
// Middleware Setup
const corsOptions = {
    origin: ["http://localhost:3000", "https://axion-ai-frontend.vercel.app", "https://axion-ai-frontend-v2.vercel.app"], // Allow your frontend domain and others
...
// health check api
app.get("/", (req, res) => {
    res.send("API is runningg by updating gemini key");
});
